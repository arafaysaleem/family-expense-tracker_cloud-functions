...
exports.updateWalletBalanceOnNewTransaction = functions.firestore
    .document(`${firestore_paths_1.FirestorePaths.BOOKS}/{bookId}/${firestore_paths_1.FirestorePaths.TRANSACTION_GROUPS}/{transactionGroupId}/${firestore_paths_1.FirestorePaths.TRANSACTIONS}/{transactionId}`)
    ...
    switch (transactionData.type) {
        ...
        case transaction_type_enum_1.default.Adjustment:
            ...
            break;
        default:
            console.log('Transaction type is neither income, expense nor transfer. Skipping wallet balance update.');
    }
    return null;
});
